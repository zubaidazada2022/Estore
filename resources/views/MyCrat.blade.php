...
@section('content')
    ...
    <div class="card card-default " >
        ...
        <div class="card-header text-center h3 text-danger">Prodact List<a href="{{route('MyCart.create')}}" class="btn btn-success float-right">New Prodact  </a>
...
<div class="card" style="width: 18rem;">
  ...
  <div class="card-body">
    ...
    <button href="#" class="btn btn-primary ">  {{$p->price}}</button>
        ...
        <a href="{{route('MyCart.edit',$p->id)}}" class="btn btn-primary   float-right py-0 px-4">
                                                       Edit </a>
   

  <form action="{{action('MyCartController@destroy',$p->id)}}" method="POST">   @method('DELETE')
